...
base_params <- c(
  ...
  # Children parameters
  beta_cc = 0.5,     # Transmission rate via child to child
  beta_ac = 0.3,         # Transmission rate via adult to child
  gamma_c = 0.05,              # Recovery rate for those who were infectious and remained in the general population 
  sigma_c = 1/5,                # Detection rate
  gamma_c_Id = 0.1,             # Recovery rate for those who were detected
  rho_c_I = 0.01,                # Mortality rate for the infected people in the community
  rho_c_Id = 0.009,               # Mortality rate for the infected people that were detected and isolated
  
  
  # Adult parameters
  beta_aa = 0.4,     # Transmission rate via adult to adult
  beta_ca = 0.25,         # Transmission rate via child to adult 
  gamma_a = 0.05,              # Recovery rate for those who were infectious and remained in the general population 
  sigma_a = 1/5,                # Detection rate
  gamma_a_Id = 0.1,             # Recovery rate for those who were detected
  rho_a_I = 0.01,                # Mortality rate for the infected people in the community
  rho_a_Id = 0.009               # Mortality rate for the infected people that were detected and isolated
)

# Define initial state
initial_state <- c(
  # Children population
  S_c = 105e2,    # Susceptible
...
# Model simulations with parameter estimations
